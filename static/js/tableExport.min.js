...
t=this.getBoundingClientRect(),q=this.offsetLeft*e.wScaleFactor,f=this.offsetTop*e.hScaleFactor,h=t.width*e.wScaleFactor;t=t.height*e.hScaleFactor;e.doc.setDrawColor.apply(void 0,g);e.doc.setFillColor.apply(void 0,d);e.doc.setLineWidth(l);e.doc.rect(b.x+q,b.y+f,h,t,l?"FD":"F")}else c(this).is("img")&&(d=ra(this.src),na(b,this,d,e));sa(b,c(this).children(),e)})}function ta(b,d,e){if("function"===typeof e.onAutotableText)e.onAutotableText(e.doc,b,d);else{var k=b.textPos.x,g=b.textPos.y,l={halign:b.styles.halign,
valign:b.styles.valign};if(d.length){for(d=d[0];d.previousSibling;)d=d.previousSibling;for(var t=!1,q=!1;d;){var f=d.innerText||d.textContent||"",h=f.length&&" "===f[0]?" ":"",m=1<f.length&&" "===f[f.length-1]?" ":"";!0!==a.preserve.leadingWS&&(f=h+ha(f));!0!==a.preserve.trailingWS&&(f=ia(f)+m);c(d).is("br")&&(k=b.textPos.x,g+=e.doc.internal.getFontSize());c(d).is("b")?t=!0:c(d).is("i")&&(q=!0);(t||q)&&e.doc.setFontType(t&&q?"bolditalic":t?"bold":"italic");if(h=e.doc.getStringUnitWidth(f)*e.doc.internal.getFontSize()){"linebreak"===
...
a.onCellHtmlData(g,d,e,l);else if(""!==l){var f=c.parseHTML(l),q=0,h=0;l="";c.each(f,function(){if(c(this).is("input"))l+=g.find("input").eq(q++).val();else if(c(this).is("select"))l+=g.find("select option:selected").eq(h++).text();else if(c(this).is("br"))l+="<br>";else if("undefined"===typeof c(this).html())l+=c(this).text();else if(void 0===jQuery().bootstrapTable||!0!==c(this).hasClass("filterControl")&&0===c(b).parents(".detail-view").length)l+=c(this).html()})}if(!0===a.htmlContent)k=c.trim(l);
else if(l&&""!==l)if(""!==c(b).data("tableexport-cellformat")){var m=l.replace(/\n/g,"\u2028").replace(/(<\s*br([^>]*)>)/gi,"\u2060"),n=c("<div/>").html(m).contents();f=!1;m="";c.each(n.text().split("\u2028"),function(b,d){0<b&&(m+=" ");!0!==a.preserve.leadingWS&&(d=ha(d));m+=!0!==a.preserve.trailingWS?ia(d):d});c.each(m.split("\u2060"),function(b,d){0<b&&(k+="\n");!0!==a.preserve.leadingWS&&(d=ha(d));!0!==a.preserve.trailingWS&&(d=ia(d));k+=d.replace(/\u00AD/g,"")});k=k.replace(/\u00A0/g," ");if("json"===
a.type||"excel"===a.type&&"xmlss"===a.mso.fileFormat||!1===a.numbers.output)f=ja(k),!1!==f&&(k=Number(f));else if(a.numbers.html.decimalMark!==a.numbers.output.decimalMark||a.numbers.html.thousandsSeparator!==a.numbers.output.thousandsSeparator)if(f=ja(k),!1!==f){n=(""+f.substr(0>f?1:0)).split(".");1===n.length&&(n[1]="");var p=3<n[0].length?n[0].length%3:0;k=(0>f?"-":"")+(a.numbers.output.thousandsSeparator?(p?n[0].substr(0,p)+a.numbers.output.thousandsSeparator:"")+n[0].substr(p).replace(/(\d{3})(?=\d)/g,
"$1"+a.numbers.output.thousandsSeparator):n[0])+(n[1].length?a.numbers.output.decimalMark+n[1]:"")}}else k=l;!0===a.escape&&(k=escape(k));"function"===typeof a.onCellData&&(k=a.onCellData(g,d,e,k))}return k}function ua(b){return 0<b.length&&!0===a.preventInjection&&0<="=+-@".indexOf(b.charAt(0))?"'"+b:b}function Ga(b,a,e){return a+"-"+e.toLowerCase()}function aa(b,a){(b=/^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/.exec(b))&&(a=[parseInt(b[1]),parseInt(b[2]),parseInt(b[3])]);return a}function va(b){var a=
...
d.style.overflow="hidden";d.style.visibility="hidden";b.appendChild(d);d.style.width=100+e;e=100/d.offsetWidth;b.removeChild(d);return a*e}return 0}function Ha(a){for(var b=new ArrayBuffer(a.length),e=new Uint8Array(b),c=0;c!==a.length;++c)e[c]=a.charCodeAt(c)&255;return b}function ra(a){var b=0,c;if(0===a.length)return b;var k=0;for(c=a.length;k<c;k++){var g=a.charCodeAt(k);b=(b<<5)-b+g;b|=0}return b}function J(b,d,c,k,g,l){var e=!0;"function"===typeof a.onBeforeSaveToFile&&(e=a.onBeforeSaveToFile(b,
d,c,k,g),"boolean"!==typeof e&&(e=!0));if(e)try{if(wa=new Blob([b],{type:c+";charset="+k}),saveAs(wa,d,!1===l),"function"===typeof a.onAfterSaveToFile)a.onAfterSaveToFile(b,d)}catch(q){fa(d,"data:"+c+(k.length?";charset="+k:"")+(g.length?";"+g:"")+","+(l?"\ufeff":""),b)}}function fa(b,d,c){var e=window.navigator.userAgent;if(!1!==b&&window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(new Blob([c]),b);else if(!1!==b&&(0<e.indexOf("MSIE ")||e.match(/Trident.*rv\:11\./))){if(d=document.createElement("iframe")){document.body.appendChild(d);
...
l=t>>2;t=(t&3)<<4|g>>4;var q=(g&15)<<2|b>>6;var h=b&63;isNaN(g)?q=h=64:isNaN(b)&&(h=64);c=c+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(t)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(q)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h)}return c}var a={csvEnclosure:'"',csvSeparator:",",csvUseBOM:!0,displayTableName:!1,escape:!1,exportHiddenCells:!1,
...
r=v(c(w));c(r).each(function(){C(this,"th,td",n,r.length,function(a,c,e){N+="<field>"+B(a,c,e)+"</field>"});n++});N+="</fields><data>";var xa=1;u=y(c(w));c(u).each(function(){var a=1;p="";C(this,"td,th",n,r.length+u.length,function(b,c,f){p+="<column-"+a+">"+B(b,c,f)+"</column-"+a+">";a++});0<p.length&&"<column-1></column-1>"!==p&&(N+='<row id="'+xa+'">'+p+"</row>",xa++);n++});N+="</data></tabledata>";if("string"===a.outputMode)return N;if("base64"===a.outputMode)return H(N);J(N,a.fileName+".xml",
"application/xml","utf-8","base64",!1)}else if("excel"===a.type&&"xmlss"===a.mso.fileFormat){var ma=[],z=[];c(w).filter(function(){return L(c(this))}).each(function(){function b(a,b,d){var e=[];c(a).each(function(){var b=0,g=0;p="";C(this,"td,th",n,d+a.length,function(a,d,l){if(null!==a){var f="";d=B(a,d,l);l="String";if(!1!==jQuery.isNumeric(d))l="Number";else{var k=Fa(d);!1!==k&&(d=k,l="Number",f+=' ss:StyleID="pct1"')}"Number"!==l&&(d=d.replace(/\n/g,"<br>"));k=S(a);a=T(a);c.each(e,function(){if(n>=
this.s.r&&n<=this.e.r&&g>=this.s.c&&g<=this.e.c)for(var a=0;a<=this.e.c-this.s.c;++a)g++,b++});if(a||k)a=a||1,k=k||1,e.push({s:{r:n,c:g},e:{r:n+a-1,c:g+k-1}});1<k&&(f+=' ss:MergeAcross="'+(k-1)+'"',g+=k-1);1<a&&(f+=' ss:MergeDown="'+(a-1)+'" ss:StyleID="rsp1"');0<b&&(f+=' ss:Index="'+(g+1)+'"',b=0);p+="<Cell"+f+'><Data ss:Type="'+l+'">'+c("<div />").text(d).html()+"</Data></Cell>\r";g++}});0<p.length&&(F+='<Row ss:AutoFitHeight="0">\r'+p+"</Row>\r");n++});return a.length}var d=c(this),e="";"string"===
...
c(this);""===X&&(X=a.mso.worksheetName||b.find("caption").text()||"Table",X=c.trim(X.replace(/[\\\/[\]*:?'"]/g,"").substring(0,31)));!1===a.exportHiddenCells&&(G=b.find("tr, th, td").filter(":hidden"),R=0<G.length);n=0;E=[];Q=P(this);F+="<table><thead>";r=v(b);c(r).each(function(){var b=c(this);p="";C(this,"th,td",n,r.length,function(c,d,g){if(null!==c){var e="",f=document.defaultView.getComputedStyle(c,null),k=document.defaultView.getComputedStyle(b[0],null);p+="<th";for(var h in a.mso.styles){var m=
f[a.mso.styles[h]];""===m&&(m=k[a.mso.styles[h]]);""!==m&&"0px none rgb(0, 0, 0)"!==m&&"rgba(0, 0, 0, 0)"!==m&&(e+=""===e?'style="':";",e+=a.mso.styles[h]+":"+m)}""!==e&&(p+=" "+e+'"');e=S(c);0<e&&(p+=' colspan="'+e+'"');e=T(c);0<e&&(p+=' rowspan="'+e+'"');p+=">"+B(c,d,g)+"</th>"}});0<p.length&&(F+="<tr>"+p+"</tr>");n++});F+="</thead><tbody>";u=y(b);c(u).each(function(){var b=c(this);p="";C(this,"td,th",n,r.length+u.length,function(d,f,g){if(null!==d){var e=B(d,f,g),k="",h=c(d).data("tableexport-msonumberformat"),
m=document.defaultView.getComputedStyle(d,null),n=document.defaultView.getComputedStyle(b[0],null);"undefined"===typeof h&&"function"===typeof a.mso.onMsoNumberFormat&&(h=a.mso.onMsoNumberFormat(d,f,g));"undefined"!==typeof h&&""!==h&&(k="style=\"mso-number-format:'"+h+"'");for(var r in a.mso.styles)h=m[a.mso.styles[r]],""===h&&(h=n[a.mso.styles[r]]),""!==h&&"0px none rgb(0, 0, 0)"!==h&&"rgba(0, 0, 0, 0)"!==h&&(k+=""===k?'style="':";",k+=a.mso.styles[r]+":"+h);p+="<td";""!==k&&(p+=" "+k+'"');f=S(d);
0<f&&(p+=' colspan="'+f+'"');d=T(d);0<d&&(p+=' rowspan="'+d+'"');"string"===typeof e&&""!==e&&(e=ua(e),e=e.replace(/\n/g,"<br>"));p+=">"+e+"</td>"}});0<p.length&&(F+="<tr>"+p+"</tr>");n++});a.displayTableName&&(F+="<tr><td></td></tr><tr><td></td></tr><tr><td>"+B(c("<p>"+a.tableName+"</p>"))+"</td></tr>");F+="</tbody></table>"});h='<html xmlns:o="urn:schemas-microsoft-com:office:office" '+h+' xmlns="http://www.w3.org/TR/REC-html40">'+('<meta http-equiv="content-type" content="application/vnd.ms-'+
